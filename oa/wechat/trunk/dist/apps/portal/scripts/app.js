...
angular.module('portal.controllers', [])
    ...
    .controller('eventDetailController', ['$scope', '$routeParams', '$window', 'globalFunction', 'globalConfig', 'articleDetailApi', 'weChat' function($scope, $routeParams, $window, globalFunction, globalConfig, articleDetailApi, weChat){
