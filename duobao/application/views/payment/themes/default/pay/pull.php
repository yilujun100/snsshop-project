            ...
            $('#btnConfirm').on('click', function(){
                ...
                if (flag) {
                    if ($('.tit-fight-luck').hasClass('tab-active')) { // 拼手气
                        ...
                        DUOBAO._post('/duogebao/luckybag/pull_bag',{people:numVal,coupon:vouchersSumVal,peopleNum:num1Val,perPeople:vouchersEachVal,wish:$('textarea[name="wishesFightLuck"]').eq(0).val(),type:2},function(data){
                            try{
                                if(data.retCode != 0){
                    ...
                    if ($('.tit-ordinary').hasClass('tab-active')) { // 普通
                        ...
                        DUOBAO._post('/duogebao//luckybag/pull_bag',{people:numVal,coupon:vouchersSumVal,peopleNum:num1Val,perPeople:vouchersEachVal,wish:$('textarea[name="wishesFightLuck"]').eq(1).val(),type:1},function(data){
                            try{
                                if(data.retCode != 0){
                                    layer.msg(data.retMsg);
                                    isClick = false;
