...
<div class="form-con">
    <form class="form" id="goods-form">
        ...
        <div class="f-item">
            ...
            <select name="goodsType" disabled="disabled" class="disabled">
        ...
        <div class="f-item">
            ...
            <input type="text" name="goodsCostPrice" id="goodsCostPrice" placeholder="成本价" value="<?=empty($goods['iCostPrice'])?'':price_format($goods['iCostPrice'])?>" disabled="disabled" class="disabled">
        </div>
        <div class="f-item">
            <label for="goodsLowestPrice">最低售价<b class="required">*</b></label>
            <input type="text" name="goodsLowestPrice" id="goodsLowestPrice" placeholder="最低售价" value="<?=empty($goods['iLowestPrice'])?'':price_format($goods['iLowestPrice'])?>" disabled="disabled" class="disabled">
        </div>
        <div class="f-item">
    ...
    $(function () {
        ...
        $form.validate({
            ...
            submitHandler: function () {
                var url = '<?=node_url('goods/edit_online')?>' + '/<?=empty($goods['iGoodsId'])?'':$goods['iGoodsId']?>',
                ...
                $.yConfirm('确认要「线上编辑」吗？<br><br><span style="color: #ff0000">注：将直接影响线上数据，操作后请认真核对相关内容！</span>', function () {
                    $form.yAjax({
                        url: url,
                        data: $form.serialize(),
