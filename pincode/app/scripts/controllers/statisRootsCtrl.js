(function() {
	'use strict';
	angular.module('pincodeApp.controller.statisRoots', [])
		.controller('statisRootsCtrl', statisRootsCtrl);

	function statisRootsCtrl($scope, dateRangePicker) {
	...
	statisRootsCtrl.$inject = ['$scope', 'dateRangePicker'];
})();