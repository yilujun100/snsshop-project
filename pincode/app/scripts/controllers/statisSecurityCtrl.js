(function() {
	'use strict';
	angular.module('pincodeApp.controller.statisSecurity', [])
		.controller('statisSecurityCtrl', statisSecurityCtrl);

	function statisSecurityCtrl($scope, dateRangePicker) {
	...
	statisSecurityCtrl.$inject = ['$scope', 'dateRangePicker'];
})();