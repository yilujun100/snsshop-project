(function() {
	'use strict';
	angular.module('pincodeApp.controller.codeCheck', [])
		.controller('codeCheckCtrl', codeCheckCtrl);

	function codeCheckCtrl($scope, dateRangePicker) {
	...
	codeCheckCtrl.$inject = ['$scope', 'dateRangePicker'];
})();